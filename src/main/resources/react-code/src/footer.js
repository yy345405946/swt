    ...
    render(){
        return (
            <Row className="swt-footer border" gutter={128}>
                ...
                <Col span={7}>
                    <Row>
                        <img src="http://localhost:8443/images/homepage/weixin.png" style={{visibility: "hidden"}} />
                        <img src="http://localhost:8443/images/homepage/weibo.png" style={{visibility: "hidden"}} />
                    </Row>
                    <Row>
